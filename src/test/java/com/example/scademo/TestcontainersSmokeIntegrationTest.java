...
/**
 * Exercises the {@code testcontainersVersion} pin in isolation from Spring/
 * WireMock so a Testcontainers bump can be verified on its own. Do not delete
 * the container wiring below to dodge a failing bump — migrate it instead.
 */
@Testcontainers
